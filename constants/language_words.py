...
OBJECT_ALIASES = [CAT_ALIASES, CASH_CRISP_ALIASES , CASH_WAD_ALIASES, CODE_ALIASES, COMPUTER_ALIASES, SKATEBORD_ALIASES, HACKERSNACKS_ALIASES, HACKER_MANUAL_ALIASES, SURGE_ALIASES, SPRAY_PAINT_ALIASES, FLOPPY_DISK_ALIASES, GRAPHICS_CARD_ALIASES, NEW_LAPTOP_ALIASES, RAM_ALIASES, ACMERAM_ALIASES, KEY_ALIASES, FIREBALL_ALIASES, CARCASS_ALIASES, CPUHEAD_ALIASES, BINARY_STRING_ALIASES]
