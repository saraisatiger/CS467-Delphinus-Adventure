...
from fileio.object_builder_new import *
...
class Room:
    ...
    def __init__(self, properties):
        ...
        if properties:
            ...
            self.object_dictionary = properties['object_dictionary']
            ...
            # REFACTOR: Rooms initialized with objects dictionary
            # TODO: Add relative path to Room object dictionary
            self.objects = []
            objects_dir = self.object_dictionary + '*.json'
            object_files = glob.glob(objects_dir)
            for object in object_files:
                with open(object) as object:
                    object_properties = json.load(object)
                    room_object = Object(object_properties)
